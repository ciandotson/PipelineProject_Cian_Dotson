library(sleuth) # make the sleuth package available to your current R session #

sample.tab <- read.table('/home/2025/cdotson/pipline/hcmv.metadata', header = TRUE) # read the metadata table already constructed #
...
write.table(sleuth.fin, '/home/2025/cdotson/pipline/hcmv_sigs.tsv', sep = '\t', row.names = FALSE) # write the data frame as a tsv file #
