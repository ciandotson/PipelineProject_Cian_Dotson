...
os.system('kallisto quant -i hcmv.idx -o ./results/SRR5660030 -b 30 -t 4 ./demo_fastqs/SRR5660030_1.fastq ~/pipline/raw_reads/fastqs/SRR5660030_2.fastq') # kallisto command that quantifies the number of reads from sample 1 #
