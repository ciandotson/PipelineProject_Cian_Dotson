...
os.system('kallisto quant -i hcmv.idx -o ./results/SRR5660030 -b 30 -t 4 ./demo_fastq/demo_SRR5660030_1.fastq ./demo_fastq/demo_SRR5660030_2.fastq') # kallisto command that quantifies the number of reads from sample 1 #
os.system('kallisto quant -i hcmv.idx -o ./results/SRR5660033 -b 30 -t 4 ./demo_fastq/demo_SRR5660033_1.fastq ./demo_fastq/demo_SRR5660033_2.fastq') # kallisto command that quantifies the number of reads from sample 2 #  
os.system('kallisto quant -i hcmv.idx -o ./results/SRR5660044 -b 30 -t 4 ./demo_fastq/demo_SRR5660044_1.fastq ./demo_fastq/demo_SRR5660044_2.fastq') # kallisto command that quantifies the number of reads from sample 3 #
os.system('kallisto quant -i hcmv.idx -o ./results/SRR5660045 -b 30 -t 4 ./demo_fastq/demo_SRR5660045_1.fastq ./demo_fastq/demo_SRR5660045_2.fastq') # kallisto command that quantifies the number of reads from sample 4 # 
